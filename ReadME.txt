...
All data processing, spatial analysis, and visualization steps were performed using QGIS version 3.42.2 to ensure full reproducibility of the workflow.
...
•	All original classes were merged into 6 classes: Agriculture, Green Areas, Urban, Water, Infrastructure, Other (see details below).
...
4. Processing Workflow
  ...
  4.  Compare the data from Urban Atlas to see how the urban core and green spaces changed over 6 periods time.
  4.	Calculate NDVI and NDBI indices (see calculation section below for formulas and band selection).
  5.	Prepare data for MOLUSCE (change modeling in QGIS, form the Raster downloaded from the UA).
